...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <div className={`${sidebarCollapsed ? 'w-20' : 'w-64'} bg-white shadow-lg border-r border-gray-200 transition-all duration-300 ease-in-out`}>
        <div className="p-6">
        ...
        <nav className="mt-6">
          <div className={`${sidebarCollapsed ? 'px-2' : 'px-6'}`}>
            ...
            <ul className="space-y-1">
              <li>
                <div className={`bg-purple-50 text-purple-700 group flex items-center ${sidebarCollapsed ? 'justify-center px-3' : 'px-3'} py-2.5 text-sm font-medium rounded-lg border border-purple-100`}>
                  <svg className={`text-purple-500 ${sidebarCollapsed ? 'h-6 w-6' : 'mr-3 h-5 w-5'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
